...
abstract class Exercise implements ActiveRecordInterface
{
    ...
    /**
     * The value for the muscle_group_id field.
     *
     * @var        int
     */
    protected $muscle_group_id;
    ...
    /**
     * @var        ChildMuscleGroup
     */
    protected $aMuscleGroup;
    ...
    /**
     * Get the [muscle_group_id] column value.
     *
     * @return int
     */
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[ExerciseTableMap::COL_NAME] = true;
        }
    ...
    public function setMuscleGroupId($v)
    {
        ...
        if ($this->muscle_group_id !== $v) {
            $this->muscle_group_id = $v;
            $this->modifiedColumns[ExerciseTableMap::COL_MUSCLE_GROUP_ID] = true;
        }

        if ($this->aMuscleGroup !== null && $this->aMuscleGroup->getId() !== $v) {
            $this->aMuscleGroup = null;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ExerciseTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setModifiedAt($v)
    {
        ...
        if ($this->modified_at !== null || $dt !== null) {
            if ($this->modified_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->modified_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ExerciseTableMap::COL_MODIFIED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ExerciseTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ExerciseTableMap::translateFieldName('MuscleGroupId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->muscle_group_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ExerciseTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ExerciseTableMap::translateFieldName('ModifiedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
    ...
    {
        if ($this->aMuscleGroup !== null && $this->muscle_group_id !== $this->aMuscleGroup->getId()) {
            $this->aMuscleGroup = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aMuscleGroup !== null) {
                if ($this->aMuscleGroup->isModified() || $this->aMuscleGroup->isNew()) {
                    $affectedRows += $this->aMuscleGroup->save($con);
                }
                $this->setMuscleGroup($this->aMuscleGroup);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ExerciseTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(ExerciseTableMap::COL_MUSCLE_GROUP_ID)) {
            $modifiedColumns[':p' . $index++]  = 'muscle_group_id';
        }
        if ($this->isColumnModified(ExerciseTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }
        if ($this->isColumnModified(ExerciseTableMap::COL_MODIFIED_AT)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'muscle_group_id':
                        $stmt->bindValue($identifier, $this->muscle_group_id, PDO::PARAM_INT);
                        break;
                    case 'created_at':
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aMuscleGroup) {
                ...
                $result[$key] = $this->aMuscleGroup->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setMuscleGroupId($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setCreatedAt($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setModifiedAt($arr[$keys[4]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ExerciseTableMap::COL_NAME)) {
            $criteria->add(ExerciseTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(ExerciseTableMap::COL_MUSCLE_GROUP_ID)) {
            $criteria->add(ExerciseTableMap::COL_MUSCLE_GROUP_ID, $this->muscle_group_id);
        }
        if ($this->isColumnModified(ExerciseTableMap::COL_CREATED_AT)) {
            $criteria->add(ExerciseTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(ExerciseTableMap::COL_MODIFIED_AT)) {
            $criteria->add(ExerciseTableMap::COL_MODIFIED_AT, $this->modified_at);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setMuscleGroupId($this->getMuscleGroupId());
    ...
    {
        if ($v === null) {
            $this->setMuscleGroupId(NULL);
        } else {
            $this->setMuscleGroupId($v->getId());
        }

        $this->aMuscleGroup = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildMuscleGroup object, it will not be re-added.
        if ($v !== null) {
            $v->addExercise($this);
        }
    ...
    /**
     * Get the associated ChildMuscleGroup object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildMuscleGroup The associated ChildMuscleGroup object.
     * @throws PropelException
     */
    public function getMuscleGroup(ConnectionInterface $con = null)
    {
        if ($this->aMuscleGroup === null && ($this->muscle_group_id !== null)) {
            $this->aMuscleGroup = ChildMuscleGroupQuery::create()->findPk($this->muscle_group_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aMuscleGroup->addExercises($this);
             */
        }

        return $this->aMuscleGroup;
    }
     ...
     * If this ChildExercise is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildExercise The current object (for fluent API support)
     */
    public function setTrainingExercises(Collection $trainingExercises, ConnectionInterface $con = null)
    {
        ...
        foreach ($trainingExercisesToDelete as $trainingExerciseRemoved) {
            $trainingExerciseRemoved->setExercise(null);
        }
     ...
     * Otherwise if this Exercise is new, it will return
     * an empty collection; or if this Exercise has previously
     * been saved, it will retrieve related TrainingExercises from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Exercise.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildTrainingExercise[] List of ChildTrainingExercise objects
     */
    public function getTrainingExercisesJoinTraining(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildTrainingExerciseQuery::create(null, $criteria);
        $query->joinWith('Training', $joinBehavior);
    ...
    {
        if (null !== $this->aMuscleGroup) {
            $this->aMuscleGroup->removeExercise($this);
        }
        $this->id = null;
        $this->name = null;
        $this->muscle_group_id = null;
