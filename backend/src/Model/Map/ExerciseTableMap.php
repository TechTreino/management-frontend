...
class ExerciseTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.ExerciseTableMap';
     ...
     */
    const OM_CLASS = '\\Exercise';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Exercise';
    ...
    {
        $this->addRelation('MuscleGroup', '\\MuscleGroup', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':muscle_group_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Exercise) { // it's a model object
