...
use AcademiaDigital\AcademiaDigital\Exercise;
use AcademiaDigital\AcademiaDigital\ExerciseQuery;
...
class ExerciseTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'AcademiaDigital.AcademiaDigital.Map.ExerciseTableMap';
     ...
     */
    const OM_CLASS = '\\AcademiaDigital\\AcademiaDigital\\Exercise';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'AcademiaDigital.AcademiaDigital.Exercise';
     ...
     */
    const COL_NAME = 'exercise.name';

    /**
     * the column name for the muscle_group_id field
     */
    const COL_MUSCLE_GROUP_ID = 'exercise.muscle_group_id';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'exercise.created_at';

    /**
     * the column name for the modified_at field
     */
    const COL_MODIFIED_AT = 'exercise.modified_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'MuscleGroupId', 'CreatedAt', 'ModifiedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'muscleGroupId', 'createdAt', 'modifiedAt', ),
        self::TYPE_COLNAME       => array(ExerciseTableMap::COL_ID, ExerciseTableMap::COL_NAME, ExerciseTableMap::COL_MUSCLE_GROUP_ID, ExerciseTableMap::COL_CREATED_AT, ExerciseTableMap::COL_MODIFIED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'muscle_group_id', 'created_at', 'modified_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'MuscleGroupId' => 2, 'CreatedAt' => 3, 'ModifiedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'muscleGroupId' => 2, 'createdAt' => 3, 'modifiedAt' => 4, ),
        self::TYPE_COLNAME       => array(ExerciseTableMap::COL_ID => 0, ExerciseTableMap::COL_NAME => 1, ExerciseTableMap::COL_MUSCLE_GROUP_ID => 2, ExerciseTableMap::COL_CREATED_AT => 3, ExerciseTableMap::COL_MODIFIED_AT => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'muscle_group_id' => 2, 'created_at' => 3, 'modified_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\AcademiaDigital\\AcademiaDigital\\Exercise');
        $this->setPackage('AcademiaDigital.AcademiaDigital');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('name', 'Name', 'VARCHAR', true, 51, null);
        $this->addForeignKey('muscle_group_id', 'MuscleGroupId', 'INTEGER', 'muscle_group', 'id', true, null, null);
    ...
    {
        $this->addRelation('MuscleGroup', '\\AcademiaDigital\\AcademiaDigital\\MuscleGroup', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':muscle_group_id',
    1 => ':id',
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ExerciseTableMap::COL_NAME);
            $criteria->addSelectColumn(ExerciseTableMap::COL_MUSCLE_GROUP_ID);
            $criteria->addSelectColumn(ExerciseTableMap::COL_CREATED_AT);
            $criteria->addSelectColumn(ExerciseTableMap::COL_MODIFIED_AT);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.name');
            $criteria->addSelectColumn($alias . '.muscle_group_id');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \AcademiaDigital\AcademiaDigital\Exercise) { // it's a model object
