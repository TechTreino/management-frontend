...
class CustomerTableMap extends TableMap
{
     ...
     */
    const COL_MODIFIED_AT = 'customer.modified_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Email', 'FirstName', 'LastName', 'Password', 'CreatedAt', 'ModifiedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'email', 'firstName', 'lastName', 'password', 'createdAt', 'modifiedAt', ),
        self::TYPE_COLNAME       => array(CustomerTableMap::COL_ID, CustomerTableMap::COL_EMAIL, CustomerTableMap::COL_FIRST_NAME, CustomerTableMap::COL_LAST_NAME, CustomerTableMap::COL_PASSWORD, CustomerTableMap::COL_CREATED_AT, CustomerTableMap::COL_MODIFIED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'email', 'first_name', 'last_name', 'password', 'created_at', 'modified_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Email' => 1, 'FirstName' => 2, 'LastName' => 3, 'Password' => 4, 'CreatedAt' => 5, 'ModifiedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'email' => 1, 'firstName' => 2, 'lastName' => 3, 'password' => 4, 'createdAt' => 5, 'modifiedAt' => 6, ),
        self::TYPE_COLNAME       => array(CustomerTableMap::COL_ID => 0, CustomerTableMap::COL_EMAIL => 1, CustomerTableMap::COL_FIRST_NAME => 2, CustomerTableMap::COL_LAST_NAME => 3, CustomerTableMap::COL_PASSWORD => 4, CustomerTableMap::COL_CREATED_AT => 5, CustomerTableMap::COL_MODIFIED_AT => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'email' => 1, 'first_name' => 2, 'last_name' => 3, 'password' => 4, 'created_at' => 5, 'modified_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('first_name', 'FirstName', 'VARCHAR', true, 21, null);
        $this->addColumn('last_name', 'LastName', 'VARCHAR', true, 31, null);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CustomerTableMap::COL_MODIFIED_AT);
        } else {
